___
* [Prepare](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#prepare)
* [Variables](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#variables)
* [Build and configuration](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#build-and-configuration)
* [Change ports](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#change-port)
* [Memory optimization](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#memory-optimization)
* [State-sync synchronization](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#state-sync-synchronization)
* [Start node](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#start-node)
* [Create a validator](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#create-a-validator)
* [Update node](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#update-node)
* [Useful commands](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#useful-commands)
  * [Node status](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#node-status)
  * [Validator info](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#validator-info)
  * [Wallet](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#wallet)
  * [Voting](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#voting)
  * [Actions](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#actions)
  * [All validators info](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#all-validators-info)
  * [Another useful commands](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#another-useful-commands)
* [Delete node](https://github.com/testnet-pride/Node-Manuals/blob/main/Archway-testnet/guide.md#delete-node)
___
## Prepare
```python
